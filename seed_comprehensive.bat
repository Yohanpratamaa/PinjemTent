...
php artisan tinker --execute="echo 'Categories: ' . App\Models\Kategori::count() . PHP_EOL; echo 'Equipment/Units: ' . App\Models\Unit::count() . PHP_EOL; echo 'Users: ' . App\Models\User::count() . PHP_EOL; echo 'Rental Records: ' . App\Models\Peminjaman::count() . PHP_EOL; echo 'Cart Items: ' . App\Models\Cart::count() . PHP_EOL; echo 'Notifications: ' . App\Models\Notification::count() . PHP_EOL;"
