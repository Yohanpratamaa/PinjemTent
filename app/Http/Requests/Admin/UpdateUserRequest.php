...
/**
 * Request class untuk validasi input saat mengupdate user
...
class UpdateUserRequest extends FormRequest
{
    ...
    {
        $userId = $this->route('user'); // Mengambil ID user dari route parameter
        ...
        $rules = [
            ...
            'email' => [
                ...
                'email',
                'max:255',
                Rule::unique('users', 'email')->ignore($userId) // Kecuali user yang sedang diupdate
            ],
            'password' => [
                'nullable',
                'string',
